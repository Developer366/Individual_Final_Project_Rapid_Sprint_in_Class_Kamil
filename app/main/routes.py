...
from app.main import bp, list
from app import db
from app.main.forms import TaskForm, AppointmentForm
from app.models import Task, List
...
#############################################################################################
#route for showing appointment form
...
def appointments():
    ...
    return render_template("main/appointment_list.html", list_appointments = list_appointments, form= form)
